...
To construct this algorithm I used the OXPath data extraction language to scrape approximately 1,700 questions (with answer counts) from Stackoverflow, tidied up the data and ran a Random Forest to classify the questions based on the outcomes (answers). 
